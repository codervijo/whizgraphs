...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      { title: "WhizGraphs — Turn SEO data into shareable infographics" },
      { name: "description", content: "WhizGraphs converts Search Console data into clean visual SEO reports for founders, consultants, and agencies." },
      { property: "og:title", content: "WhizGraphs — SEO infographics from your GSC data" },
      { property: "og:description", content: "Generate polished SEO infographics in seconds from Google Search Console-style data." },
    ],
  }),
  component: Home,
});
      ...
      <section className="border-t border-border bg-surface">
        <div className="container-page py-16">
          <div className="flex items-end justify-between">
            ...
            <Link to="/seo-infographic-examples" className="hidden text-sm font-medium text-primary md:inline-flex">
              View all →
            </Link>
          </div>
